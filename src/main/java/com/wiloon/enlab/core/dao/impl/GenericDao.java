...
/**
 * @param <T>
 * @param <PK> test for in line link {@link com.wiloon.enlab.domain.ECP#getID
 *             labelTest}
 * @author wiloon
 */
public class GenericDao<T, PK extends Serializable> extends SqlMapClientDaoSupport implements
    ...
    @Override
    public T getObject(String statement, T object) {
        return (T) getSqlMapClientTemplate().queryForObject(statement, object);
    }
